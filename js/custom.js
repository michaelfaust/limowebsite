$(document).ready(function() {
    ...
    $('#applyBtn').click(function() {
        $('.tryform .applyform').addClass('fadeOutUp hide');
        $('.tryform .applymsg').addClass('fadeInUp show');
    });

    //Newsletter
    // Checking subcribe form when focus event
    // $('#newsletter input[type="text"], .assan-newsletter input[type="email"]').live('focus keypress', function() {
    //     var $email = $(this);
